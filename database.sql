...
--
-- Host: 127.0.0.1
-- Czas generowania: 23 Sty 2023, 17:59
...
--
-- Struktura tabeli dla tabeli `fitatu`
--
...
CREATE TABLE `fitatu` (
  ...
  `which_meal` varchar(100) NOT NULL,
  `date` date NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Zrzut danych tabeli `fitatu`
--

INSERT INTO `fitatu` (`id`, `user_id`, `product_id`, `quantity`, `which_meal`, `date`) VALUES
(6, 125, 3, 21, 'breakfast', '2023-01-21'),
(7, 125, 3, 123, 'lunch', '2023-01-21'),
(9, 125, 4, 213, 'dinner', '2023-01-21'),
(10, 125, 4, 23, 'breakfast', '2023-01-21'),
(11, 125, 3, 213, 'lunch', '2023-01-21'),
(12, 125, 8, 10, 'lunch', '2023-01-21'),
(13, 129, 3, 100, 'breakfast', '2023-01-22'),
(14, 129, 9, 5, 'breakfast', '2023-01-22'),
(15, 129, 4, 50, 'breakfast', '2023-01-22'),
(16, 129, 6, 300, 'dinner', '2023-01-22'),
(17, 129, 8, 20, 'dinner', '2023-01-22');

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `fitatu_products`
--

CREATE TABLE `fitatu_products` (
  `id` int(11) NOT NULL,
...
--
-- Zrzut danych tabeli `fitatu_products`
--

INSERT INTO `fitatu_products` (`id`, `name`, `kcal`, `protein`, `fat`, `carbs`) VALUES
(3, 'Chleb', 264, 9, 3, 49),
(4, 'Jajko', 155, 13, 11, 1),
(6, 'Ziemniaki', 77, 2, 0, 17),
(8, 'Oliwa z oliwek', 884, 0, 100, 0),
(9, 'Masło', 717, 1, 81, 0);
...
(125, 'PatrykKalinowski', 'patrykkalinowski99@wp.pl', '$2y$10$y4NDOtkGI6LkDVZxaBYEEubMG0sLb/a29fHrvXz/V6f4fM18qMFOm', 'Patryk', 'Kalinowski', 3, 24, 70, 185, 1787),
...
(129, 'root', 'root@admin.pl', '$2y$10$9mKxW2rirRanfrLt75i9xed.amdXR36tIPxzyKBZyFlmXqpGN6F7C', 'root', 'root', 3, 24, 70, 185, 1787);
...
--
-- Indeksy dla tabeli `fitatu`
--
ALTER TABLE `fitatu`
  ADD PRIMARY KEY (`id`);

--
-- Indeksy dla tabeli `fitatu_products`
--
ALTER TABLE `fitatu_products`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT dla tabeli `fitatu`
--
ALTER TABLE `fitatu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT dla tabeli `fitatu_products`
--
ALTER TABLE `fitatu_products`
