...
<html lang="pl">
    ...
    <body>
        ...
        <div class="text-center">  
            <h2 class="fade-in-text">Pełna lista dostępnych planów treningowych</h2>
        </div>
        <div>
            <div class="content-training-plans">
                ...
                <div class="" style="padding-right: 10px; padding-left: 10px;">
                    ...
                    <br>
                    <?php 
                        $origin = $funkcje->getProductOrigin($plan['origin_number']);
                    if($plan['origin_number'] != 0) {echo "Pochodzenie: " .$origin[0]; }?>
                    <br>
                    <?php $category = $funkcje->getProductCategory($plan['category_number']);
                     if($plan['category_number'] != 0) {echo "Kategoria: ".$category[0]; }?>
                    <br>
