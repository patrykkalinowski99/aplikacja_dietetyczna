<?php
    ...
    if(isset($_POST['title']) && isset($_POST['price']) && isset($_POST['description']))//Jeśli wyslal formularz to wstaw do bazy danych i przekieruj do logowania
    {
        ...
        $result = $funkcje->addProduct($_POST['title'], $_POST['description'], $_POST['price'], $image_number .".". $whatIWant, $_POST['product_type'], $_POST['product_origin'], $_POST['product_category']);//Jesli true to znaczy, ze zarejestrowalo(sprawdz return w metodzie register w Funkcje.php)
        if($result)
        {
...
<html lang="pl">
    ...
    <body>
        ...
        <div class="login-register-page">  
            <h2 class="fade-in-text">Dodawanie produktu</h2>
